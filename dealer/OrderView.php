                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#" id="SortingOrderASC" onclick="orderBy(0)">Sorting By OrderID ASC</a></li>
                                        <li><a class="dropdown-item" href="#" id="SortingOrderDESC" onclick="orderBy(1)">Sorting By OrderID DESC</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        ?><tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#Modal-Detail" onclick="uploadOrderDetail(<?php echo $row['orderID']; ?>,'<?php echo $row['orderDateTime'] ?>','<?php echo $row['deliveryAddress'] ?>','<?php echo $deliveryDate ?>','<?php echo $row['orderPrice'] ?>')">Details</button>
                                    </td>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <button type="button" class="btn btn-outline-danger" id="cancelButton<?php echo $row['orderID']; ?>" onclick="cancelOrder('<?php echo $row['orderID']; ?>','<?php echo $row['requestCancelStatus']; ?>')">Cancel Order</button>
                                        </td>
                                    <?php } ?>
                                </tr>
                        <?php
