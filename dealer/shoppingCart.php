                  ...
                  if (isset($_SESSION['cart'])&& !empty($_SESSION['cart'])) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        ...
                        $spareQty = 0;
                            ...
                            ?>
                                    <div class="showcase">
                                        <input type="checkbox" class="checkbox" id="SelectedItem<?php echo $index?>"
                                            onchange="handleCheckboxChange(this,'<?php echo $row['sparePartName']; ?>',<?php echo $row['sparePartNum']; ?>,<?php echo $row['weight'];?>,'quantityNumber<?php echo $index?>',<?php echo $row['price'] ?>)">

                                        <a href="#" class="showcase-img-box">
                                            <img src="<?php echo $row['sparePartImage']; ?>" width="70"
                                                class="showcase-img" />
                                        </a>

                                        <div class="showcase-content">
                                            <i class="bx bx-x red zoom"
                                                onclick="removeFromSession(<?php echo $row['sparePartNum']; ?>)"></i>
                                            <a href="#">
                                            ...
                                            <div class="quantity" id="quantityForitemNum">
                                                <button
                                                    onclick="quantityDecrement(<?php echo $index?>,<?php echo $row['sparePartNum']; ?>)">
                                                ...
                                                <input type="number" id="quantityNumber<?php echo $index?>"
                                                    name="quantity" value="<?php echo $spareQty; ?>" readonly>
                                                <button
                                                    onclick="quantityIncrement(<?php echo $index?>,<?php echo $row['stockItemQty']; ?>)">
                                                    <svg fill="none" viewBox="0 0 24 24" height="14" width="14"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path stroke-linejoin="round" stroke-linecap="round"
                                                            stroke-width="2.5" stroke="#47484b" d="M12 4V20M20 12H4">
                                                        </path>
                                                    </svg>
                                                </button>
                                            </div>
                ...
                <div class="w-50">
                    ...
                    <div class="checkbox-wrapper-16">
                        <label class="checkbox-wrapper">
                            <input class="checkbox-input" type="radio" value="weight" name="deliveryMode"
                                onchange="calDeliveryCost(this)">
                        ...
                        <label class="checkbox-wrapper" style="margin-left: 30px;">
                            <input class="checkbox-input" type="radio" value="quantity" name="deliveryMode"
                                onchange="calDeliveryCost(this)">
                            <span class="checkbox-tile">
                                <span class="checkbox-icon">
